...
<section id="aboutUs"><!--Aboutus pradzia-->
<div class="inner_wrapper">
  <div class="container">
    <h2>About Us</h2>
    <div class="inner_section">
	<div class="row">
      <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="{{ asset('img/about-img.jpeg') }}" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
